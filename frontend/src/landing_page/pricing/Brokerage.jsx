...
function Brokerage() {
  return (
    ...
    >
      ...
      <div className="container homeContainer table-responsive  px-0">
        <table class="table table-hover table-borderless border text-start mb-0 pe-0">
          <thead>
      ...
      <div className="container px-0">
        ...
        <div className="d-flex justify-content-between gap-lg-0 gap-3">
