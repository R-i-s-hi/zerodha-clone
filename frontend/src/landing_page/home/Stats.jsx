        ...
        <div className='container homeContainer' style={{color: "#424242"}}>
            <div className='flexContainer'>
                <div style={{width: '50%'}}>
                    ...
                    <div className='trustContainer' style={{width: "100% !important"}}>
                        <div className='mb-4'>
                    ...
                    <span className='trustDiv' style={{width: "100% !important"}}>
                        <span className='mb-4 w-50'>
                            <h4 className='mt-1'>Customer-first always</h4>
                            <p className='text-muted fw-medium' style={{fontSize: "14px"}}>That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments and contribute to 15% of daily retail exchange volumes in India.</p>
                        </span>
                        <span className='mb-4 w-50'>
                ...
                <div style={{width: '50%'}}>
                    <img src='images/ecosystem.png' alt='ecosystem' style={{width: "100%"}}></img>
