...
function Hero() {
    return ( 
        <div className='bg-primary text-white' style={{paddingTop: "8rem", width: "100%"}}>
            <div className='d-flex justify-content-between container supportContainer'>
                <h3 className='fw-semibold'>Suppport Portal</h3>
                <p className='border-bottom mb-5 pb-2 fw-medium'>Track Tickets</p>
            </div>
            <div className='d-flex justify-content-between align-items-center gap-5 container supportContainer'>
                <div>
                    ...
                    <div className='d-flex flex-wrap justify-content-between gap-4 w-lg-50 w-75' style={{marginBottom: "3rem"}}>
                        ...
                        <h3 className='border-bottom fs-6 mb-3 pb-2'>Kite user manual</h3>
                    </div>
                </div>
                <div className='d-lg-flex flex-column d-none pt-5 text-white'>
